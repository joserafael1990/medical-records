...
('Sepsis', 'A41.9', (SELECT id FROM diagnosis_categories WHERE code = 'A00-B99' LIMIT 1), 'Infección sistémica grave', 'Medicina General', 'severe', false, false, NULL, NULL, true),
('Infección viral', 'B34.9', (SELECT id FROM diagnosis_categories WHERE code = 'A00-B99' LIMIT 1), 'Infección viral', 'Medicina General', 'moderate', false, true, NULL, NULL, true),
...
('Tuberculosis pulmonar', 'A15.9', (SELECT id FROM diagnosis_categories WHERE code = 'A00-B99' LIMIT 1), 'Tuberculosis pulmonar', 'Neumología', 'severe', true, true, 'adult', 'both', true),
...
('Hipotiroidismo', 'E03.9', (SELECT id FROM diagnosis_categories WHERE code = 'E00-E89' LIMIT 1), 'Hipotiroidismo', 'Endocrinología', 'moderate', true, false, 'all', 'both', true),
('Obesidad', 'E66.9', (SELECT id FROM diagnosis_categories WHERE code = 'E00-E89' LIMIT 1), 'Obesidad sin especificar tipo', 'Endocrinología', 'moderate', true, false, 'all', 'both', true),
('Hipertiroidismo', 'E05.9', (SELECT id FROM diagnosis_categories WHERE code = 'E00-E89' LIMIT 1), 'Hipertiroidismo', 'Endocrinología', 'moderate', true, false, 'all', 'both', true),
('Síndrome metabólico', 'E88.9', (SELECT id FROM diagnosis_categories WHERE code = 'E00-E89' LIMIT 1), 'Trastorno metabólico', 'Endocrinología', 'moderate', true, false, 'adult', 'both', true),
...
('Bocio no tóxico', 'E04.9', (SELECT id FROM diagnosis_categories WHERE code = 'E00-E89' LIMIT 1), 'Bocio', 'Endocrinología', 'mild', true, false, 'all', 'both', true),
...
('Gota', 'M10.9', (SELECT id FROM diagnosis_categories WHERE code = 'E00-E89' LIMIT 1), 'Gota', 'Reumatología', 'moderate', true, false, 'adult', 'both', true),
...
('Enfermedad cardíaca isquémica crónica', 'I25.9', (SELECT id FROM diagnosis_categories WHERE code = 'I00-I99' LIMIT 1), 'Cardiopatía isquémica crónica', 'Cardiología', 'severe', true, false, 'adult', 'both', true),
('Infarto cerebral', 'I63.9', (SELECT id FROM diagnosis_categories WHERE code = 'I00-I99' LIMIT 1), 'Accidente cerebrovascular isquémico', 'Neurología', 'severe', false, false, 'adult', 'both', true),
('Insuficiencia cardíaca', 'I50.9', (SELECT id FROM diagnosis_categories WHERE code = 'I00-I99' LIMIT 1), 'Insuficiencia cardíaca', 'Cardiología', 'severe', true, false, 'adult', 'both', true),
('Arritmia cardíaca', 'I49.9', (SELECT id FROM diagnosis_categories WHERE code = 'I00-I99' LIMIT 1), 'Arritmia', 'Cardiología', 'moderate', false, false, 'all', 'both', true),
...
('Infección aguda de las vías respiratorias superiores', 'J06.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Infección respiratoria alta', 'Medicina General', 'mild', false, true, 'all', NULL, true),
('Neumonía', 'J18.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Neumonía sin especificar agente', 'Neumología', 'moderate', false, false, 'all', NULL, true),
...
('Asma', 'J45.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Asma', 'Neumología', 'moderate', true, false, 'all', NULL, true),
('Bronquitis aguda', 'J20.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Bronquitis aguda', 'Medicina General', 'mild', false, true, 'all', NULL, true),
('Bronquitis crónica', 'J41.0', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Bronquitis crónica simple', 'Neumología', 'moderate', true, false, 'adult', 'both', true),
('Enfisema pulmonar', 'J43.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Enfisema', 'Neumología', 'moderate', true, false, 'adult', 'both', true),
...
('Sinusitis aguda', 'J01.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Sinusitis aguda', 'Medicina General', 'mild', false, false, 'all', 'both', true),
('Rinitis alérgica', 'J30.9', (SELECT id FROM diagnosis_categories WHERE code = 'J00-J99' LIMIT 1), 'Rinitis alérgica', 'Medicina General', 'mild', true, false, 'all', 'both', true),
...
('Apendicitis aguda', 'K35.9', (SELECT id FROM diagnosis_categories WHERE code = 'K00-K95' LIMIT 1), 'Apendicitis aguda', 'Cirugía', 'severe', false, false, 'all', NULL, true),
('Enfermedad hepática', 'K76.9', (SELECT id FROM diagnosis_categories WHERE code = 'K00-K95' LIMIT 1), 'Trastorno hepático', 'Gastroenterología', 'moderate', true, false, 'adult', 'both', true),
('Gastritis', 'K29.9', (SELECT id FROM diagnosis_categories WHERE code = 'K00-K95' LIMIT 1), 'Gastritis', 'Gastroenterología', 'mild', true, false, 'all', 'both', true),
...
('Hepatitis crónica', 'K73.9', (SELECT id FROM diagnosis_categories WHERE code = 'K00-K95' LIMIT 1), 'Hepatitis crónica', 'Gastroenterología', 'moderate', true, false, 'adult', 'both', true),
...
('Enfermedad inflamatoria intestinal', 'K50.9', (SELECT id FROM diagnosis_categories WHERE code = 'K00-K95' LIMIT 1), 'Enfermedad de Crohn', 'Gastroenterología', 'moderate', true, false, 'adult', 'both', true),

-- Genitourinario (N00-N99) - 50 diagnósticos
('Infección del tracto urinario', 'N39.0', (SELECT id FROM diagnosis_categories WHERE code = 'N00-N99' LIMIT 1), 'Infección urinaria', 'Urología', 'moderate', false, false, 'all', NULL, true),
...
('Litiasis renal', 'N20.9', (SELECT id FROM diagnosis_categories WHERE code = 'N00-N99' LIMIT 1), 'Cálculos renales', 'Urología', 'moderate', false, false, 'adult', 'both', true),
...
('Incontinencia urinaria', 'N39.4', (SELECT id FROM diagnosis_categories WHERE code = 'N00-N99' LIMIT 1), 'Pérdida involuntaria de orina', 'Urología', 'mild', false, false, 'all', 'both', true),
...
('Cistitis', 'N30.9', (SELECT id FROM diagnosis_categories WHERE code = 'N00-N99' LIMIT 1), 'Cistitis', 'Urología', 'moderate', false, false, 'all', 'both', true),
...
('Episodio depresivo', 'F32.9', (SELECT id FROM diagnosis_categories WHERE code = 'F01-F99' LIMIT 1), 'Depresión', 'Psiquiatría', 'moderate', true, false, 'adult', 'both', true),
('Trastorno de ansiedad', 'F41.9', (SELECT id FROM diagnosis_categories WHERE code = 'F01-F99' LIMIT 1), 'Trastorno de ansiedad', 'Psiquiatría', 'moderate', true, false, 'adult', 'both', true),
...
('Esquizofrenia', 'F20.9', (SELECT id FROM diagnosis_categories WHERE code = 'F01-F99' LIMIT 1), 'Esquizofrenia', 'Psiquiatría', 'severe', true, false, 'adult', 'both', true),
('Trastorno bipolar', 'F31.9', (SELECT id FROM diagnosis_categories WHERE code = 'F01-F99' LIMIT 1), 'Trastorno bipolar', 'Psiquiatría', 'severe', true, false, 'adult', 'both', true),
('Trastorno obsesivo-compulsivo', 'F42.9', (SELECT id FROM diagnosis_categories WHERE code = 'F01-F99' LIMIT 1), 'TOC', 'Psiquiatría', 'moderate', true, false, 'adult', 'both', true),
...
('Epilepsia', 'G40.9', (SELECT id FROM diagnosis_categories WHERE code = 'G00-G99' LIMIT 1), 'Epilepsia sin especificar tipo', 'Neurología', 'moderate', true, false, 'all', NULL, true),
...
('Enfermedad de Parkinson', 'G20', (SELECT id FROM diagnosis_categories WHERE code = 'G00-G99' LIMIT 1), 'Parkinson', 'Neurología', 'moderate', true, false, 'adult', 'both', true),
('Neuropatía periférica', 'G62.9', (SELECT id FROM diagnosis_categories WHERE code = 'G00-G99' LIMIT 1), 'Neuropatía periférica', 'Neurología', 'moderate', true, false, 'adult', 'both', true),
...
('Demencia', 'F03', (SELECT id FROM diagnosis_categories WHERE code = 'G00-G99' LIMIT 1), 'Demencia', 'Neurología', 'moderate', true, false, 'geriatric', 'both', true),
...
('Artritis reumatoide', 'M06.9', (SELECT id FROM diagnosis_categories WHERE code = 'M00-M99' LIMIT 1), 'Artritis reumatoide', 'Reumatología', 'moderate', true, false, 'adult', 'both', true),
('Osteoartritis', 'M19.9', (SELECT id FROM diagnosis_categories WHERE code = 'M00-M99' LIMIT 1), 'Artrosis', 'Reumatología', 'moderate', true, false, 'adult', 'both', true),
...
('Lumbalgia', 'M54.5', (SELECT id FROM diagnosis_categories WHERE code = 'M00-M99' LIMIT 1), 'Dolor lumbar', 'Medicina General', 'mild', true, false, 'adult', 'both', true),
('Tendinitis', 'M79.31', (SELECT id FROM diagnosis_categories WHERE code = 'M00-M99' LIMIT 1), 'Inflamación de tendón', 'Medicina General', 'moderate', false, false, 'adult', 'both', true),
...
('Bursitis', 'M71.9', (SELECT id FROM diagnosis_categories WHERE code = 'M00-M99' LIMIT 1), 'Inflamación de bursa', 'Reumatología', 'moderate', false, false, 'adult', 'both', true),
