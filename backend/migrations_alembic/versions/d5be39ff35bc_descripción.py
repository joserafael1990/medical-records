...
def safe_drop_index(*args, **kwargs) -> None:
    ...
    try:
        # Always add if_exists=True if not already present
        if 'if_exists' not in kwargs:
            kwargs['if_exists'] = True
        op.drop_index(*args, **kwargs)
    except Exception:
        pass  # Index might not exist or transaction might be aborted
...
def upgrade() -> None:
    ...
    safe_drop_index('idx_diagnosis_catalog_code', table_name='diagnosis_catalog')
    safe_drop_index('idx_diagnosis_catalog_created_by', table_name='diagnosis_catalog')
    ...
    safe_drop_index('idx_document_folio_sequences_doctor_type', table_name='document_folio_sequences')
    ...
    safe_drop_index('idx_document_folios_doctor_type_number', table_name='document_folios')
    safe_drop_index('idx_document_folios_unique_consultation', table_name='document_folios')
    ...
    safe_alter_column('google_calendar_event_mappings', 'doctor_id',
               ...
               existing_nullable=False)
    safe_drop_index('idx_google_event_mappings_appointment_id', table_name='google_calendar_event_mappings')
    safe_drop_index('idx_google_event_mappings_doctor_id', table_name='google_calendar_event_mappings')
    safe_drop_index('idx_google_event_mappings_google_event_id', table_name='google_calendar_event_mappings')
    safe_drop_table_comment(
    ...
    safe_drop_index('idx_google_calendar_tokens_channel_id', table_name='google_calendar_tokens')
    safe_drop_index('idx_google_calendar_tokens_doctor_id', table_name='google_calendar_tokens')
    safe_drop_index('idx_google_calendar_tokens_resource_id', table_name='google_calendar_tokens')
    safe_drop_index('idx_google_calendar_tokens_sync_enabled', table_name='google_calendar_tokens')
    safe_drop_table_comment(
    ...
    safe_drop_index('idx_medical_records_anonymized', table_name='medical_records')
    safe_drop_index('idx_medical_records_archived', table_name='medical_records')
    safe_drop_index('idx_medical_records_consultation_date', table_name='medical_records')
    safe_drop_index('idx_medical_records_doctor_id', table_name='medical_records')
    safe_drop_index('idx_medical_records_legal_hold', table_name='medical_records', postgresql_where='(legal_hold = true)')
    safe_drop_index('idx_medical_records_patient_doctor', table_name='medical_records')
    safe_drop_index('idx_medical_records_patient_document', table_name='medical_records')
    safe_drop_index('idx_medical_records_patient_id', table_name='medical_records')
    safe_drop_index('idx_medical_records_retention_end', table_name='medical_records', postgresql_where='((retention_end_date IS NOT NULL) AND (is_anonymized = false))')
    safe_drop_table_comment(
        'medical_records',
    ...
    safe_drop_index('idx_offices_doctor_id', table_name='offices')
    safe_drop_index('idx_offices_is_active', table_name='offices')
    safe_drop_index('idx_person_documents_document_id', table_name='person_documents')
    safe_drop_index('idx_person_documents_person_id', table_name='person_documents')
    safe_drop_index('idx_person_documents_value', table_name='person_documents')
    ...
    safe_alter_column('persons', 'gender',
               ...
               existing_nullable=True)
    safe_drop_index('idx_persons_email', table_name='persons')
    safe_drop_index('idx_persons_person_type', table_name='persons')
    ...
    safe_drop_index('idx_privacy_consents_anonymized', table_name='privacy_consents')
    safe_drop_index('idx_privacy_consents_deletion_scheduled', table_name='privacy_consents', postgresql_where='((deletion_scheduled_date IS NOT NULL) AND (is_anonymized = false))')
    safe_drop_table_comment(
        'privacy_consents',
...
def downgrade() -> None:
    ...
    safe_drop_index(op.f('ix_study_categories_id'), table_name='study_categories')
    op.create_table_comment(
        'study_catalog',
    ...
    safe_drop_index(op.f('ix_study_catalog_id'), table_name='study_catalog')
    safe_alter_column('study_catalog', 'category_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.create_table_comment(
    ...
    safe_drop_index(op.f('ix_schedule_templates_id'), table_name='schedule_templates')
    safe_alter_column('schedule_templates', 'office_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    ...
    safe_drop_index(op.f('ix_diagnosis_catalog_id'), table_name='diagnosis_catalog')
    safe_drop_index(op.f('ix_diagnosis_catalog_created_by'), table_name='diagnosis_catalog')
    safe_drop_index(op.f('ix_diagnosis_catalog_code'), table_name='diagnosis_catalog')
    ...
    safe_drop_index(op.f('ix_clinical_studies_id'), table_name='clinical_studies')
